...
def generar_batch_familia_ia():
    ...
    - Deben representar situaciones cotidianas y realistas dentro de una familia.
...
def generar_batch_familia_ia_adaptativo(historial):
    ...
    Generá los próximos 10 ejercicios adaptándolos a ese desempeño.
